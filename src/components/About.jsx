...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="reveal max-w-4xl mx-auto text-center md:text-left">
        ...
        <p className="text-light-muted dark:text-dark-muted mb-12 text-lg leading-relaxed">
        ...
        <div>
          <h3 className="text-xl font-semibold mb-6 text-center md:text-left">Technical Arsenal</h3>
